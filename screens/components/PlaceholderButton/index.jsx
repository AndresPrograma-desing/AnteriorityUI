...
const PlaceholderButton = ({
  ...
  return (
    <div
      className={`${styles.configContainer} ${disabled ? styles.disabledContainer : ''}`}
      style={{
        ...(focusColor ? { '--placeholderbutton-focus': focusColor } : {}),
        ...(unitBgColor ? { '--placeholderbutton-unit-bg': unitBgColor } : {}),
      }}
    >
