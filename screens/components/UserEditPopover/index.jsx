...
import { getUserId } from '../../../common/storage/LocalStorage';
import Button from '../Button/index'

const UserEditPopover = ({ open, anchorEl, onClose, currentName, onSuccess, bgColor, saveColor, cancelColor }) => {
    ...
    <Popover
      ...
      slotProps={{
        paper: {
          ...
          style: {
            ...(bgColor ? { '--usereditpopover-bg': bgColor } : {}),
            ...(saveColor ? { '--usereditpopover-save': saveColor } : {}),
            ...(cancelColor ? { '--usereditpopover-cancel': cancelColor } : {}),
          }
        }
      }}
    >
